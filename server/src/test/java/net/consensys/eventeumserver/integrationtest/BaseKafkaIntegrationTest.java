...
public class BaseKafkaIntegrationTest extends BaseIntegrationTest {
  ...
  private final List<EventeumMessage<ContractEventFilter>> broadcastFiltersEventMessages =
      new ArrayList<>();
  private final List<EventeumMessage<TransactionMonitoringSpec>> broadcastTransactionEventMessages =
      new ArrayList<>();
  ...
  private void startKafkaContainer() {
    ...
    ContainerTestUtils.waitForAssignment(
        testContainer, embeddedKafka.getTopics().size() * embeddedKafka.getPartitionsPerTopic());
