...
import io.librevents.annotation.ConditionalOnKafkaRequired;
...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, LibreventsMessage> eventeumProducerFactory() {
    ...
    @Bean
    public ConsumerFactory<String, LibreventsMessage> eventeumConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                props, null, new JsonDeserializer<>(LibreventsMessage.class));
    }
    ...
    @Bean
    public KafkaTemplate<String, LibreventsMessage> eventeumKafkaTemplate() {
        return new KafkaTemplate<>(eventeumProducerFactory());
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, LibreventsMessage>
            eventeumKafkaListenerContainerFactory() {

        ConcurrentKafkaListenerContainerFactory<String, LibreventsMessage> factory =
