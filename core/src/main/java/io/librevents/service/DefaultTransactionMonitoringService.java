...
import io.librevents.chain.block.tx.TransactionMonitoringBlockListener;
import io.librevents.chain.block.tx.criteria.TransactionMatchingCriteria;
import io.librevents.chain.block.tx.criteria.factory.TransactionMatchingCriteriaFactory;
...
public class DefaultTransactionMonitoringService implements TransactionMonitoringService {
    ...
    private final LibreventsEventBroadcaster libreventsEventBroadcaster;
    ...
    public DefaultTransactionMonitoringService(
            LibreventsEventBroadcaster libreventsEventBroadcaster,
        ...
        this.libreventsEventBroadcaster = libreventsEventBroadcaster;
    ...
    public void registerTransactionsToMonitor(TransactionMonitoringSpec spec, boolean broadcast) {
        ...
        if (broadcast) {
            libreventsEventBroadcaster.broadcastTransactionMonitorAdded(spec);
        }
    }
    ...
    public void stopMonitoringTransactions(String monitorId, boolean broadcast)
        ...
        if (broadcast) {
            libreventsEventBroadcaster.broadcastTransactionMonitorRemoved(
