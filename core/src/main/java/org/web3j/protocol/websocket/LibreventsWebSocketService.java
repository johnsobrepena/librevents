...
@Slf4j
@Getter
public class LibreventsWebSocketService extends WebSocketService {

    private final WebSocketClient webSocketClient;

    public LibreventsWebSocketService(
            WebSocketClient webSocketClient, boolean includeRawResponses) {
